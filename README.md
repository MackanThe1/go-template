...
2. **Edit `go.mod`** 
   Change the module path from: `module github.com/MackanThe1/d7024e-tutorial` to your new project path.
...
- `internal/cli/talk.go`  
  Line 4:
  ```go
  "github.com/MackanThe1/d7024e-tutorial/pkg/helloworld"
  ```
...
Replace each instance of `github.com/MackanThe1/d7024e-tutorial` with your new module name.
...
Published releases will appear here: [GitHub Releases - MackanThe1/d7024e-tutorial](https://github.com/MackanThe1/d7024e-tutorial/releases)

The Docker workflow will automatically build and publish a Docker image on GitHub.  
See this page: [GitHub Packages - MackanThe1/d7024e-tutorial](https://github.com/MackanThe1/d7024e-tutorial/pkgs/container/MackanThe1/d7024e-tutorial)
